...
public class ValidationTest {
  ...
  public void testRecursiveRule() {
    ...
    _builder.append("fire(Window.open)");
    _builder.newLine();
    this.assertWarning(_builder, XbasePackage.Literals.XFEATURE_CALL, "Firing the same device state that triggers the rule \"Recursive rule\" may lead to endless recursion.");
  }
